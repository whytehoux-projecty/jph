...
export default async function DeclinedPortalRequestsPage() {
  const enrichedRequests = await getEnrichedRequests({ status: 'REJECTED' });

  return (
    <AdminPageShell 
      title="Declined Access Requests" 
      subtitle="Online banking access requests that were rejected."
    >
      <AdminRequestList 
